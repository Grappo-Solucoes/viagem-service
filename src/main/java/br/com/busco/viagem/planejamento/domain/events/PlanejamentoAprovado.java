...
@AllArgsConstructor
@NoArgsConstructor
public class PlanejamentoAprovado implements DomainEvent {
    @NotNull(message = "O parâmetro 'id' é obrigatório!")
    private PlanejamentoId id;
    private Instant occurredOn;

    public static PlanejamentoAprovado from(Planejamento planejamento) {
        return new PlanejamentoAprovado(planejamento.getId(), Instant.now());
    }
}

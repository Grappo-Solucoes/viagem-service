...
@AllArgsConstructor
@NoArgsConstructor
public class OcorrenciaFinalizada implements DomainEvent {

    @NotNull(message = "O parametro 'id' e obrigatorio!")
    private OcorrenciaId id;
    private Instant occurredOn;

    public static OcorrenciaFinalizada from(Ocorrencia ocorrencia) {
        return new OcorrenciaFinalizada(ocorrencia.getId(), Instant.now());
    }
}
